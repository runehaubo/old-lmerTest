...
TOL <- 1e-1
stopifnot(all.equal(an$DenDF,
                    c(61.0403, 36.5587, 67.0312, 68.505, 134.152, 81.2094, 215.628), tol = TOL))

stopifnot(all.equal(an$F.value,
                    c(40.6522, 6.2784, 46.0567, 4.2176, 2.7903, 2.5043, 0.2995), tol = TOL))
